  ...
  >
    <v-navigation-drawer permanent expand-on-hover>
      ...
      <v-list nav dense>
        ...
        <router-link to="/dashboard/book-list" class="menu link">
          <v-list-item link>
            <v-list-item-icon>
              <v-icon>mdi-format-list-bulleted</v-icon>
            </v-list-item-icon>
            <v-list-item-title> Kitap Listesi </v-list-item-title>
          </v-list-item>
        </router-link>
...
export default {
  name: "dashboard",
  methods: {
    ...mapActions("authModule", ["useLocalTokenToLogInAction"]),
    localstorageLogin() {
      this.useLocalTokenToLogInAction().then();
    }
  },
  computed: {
